...
from .transforms import ScaleAugmentation, ScaleToLimitRange, RandomRotate,GausianBlur
...
class CROHMEDataset(Dataset):
    def __init__(self, ds, is_train: bool, scale_aug: bool) -> None:
        ...
        #trans_list = []
        '''
        Implement RandomRotate and GausianBlur in training procedure
        '''
        trans_list = []
        if is_train:
            trans_list.append(RandomRotate())
